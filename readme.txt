...
3. Go into the admin panel of the plugin and fill the 'Image alternative text (alt attribute content)' field with the alternative you fish to display
default : "Opens in a new window" 
3. add a class of "external" on the links you wish to open in a new window. 
